            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <a href="{{ route('products.index') }}" class="btn btn-sm btn-primary ml-auto">Return to Data</a>
                    </div>
...
{{--                                <label class="custom-file-label" for="validatedCustomFile">Choose Excel file...</label>--}}
                                <input type="file" name="attachment" id="validatedCustomFile">
                                @error('attachment')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="pt-4">
                                <button type="submit" class="btn btn-sm btn-primary">Save To Database</button>
                            </div>
                        </form>
                    </div>
                </div>
